...
function archive_generator(locals) {
  ...
  let archiveDir = config['archive-generator']['archive-dir'] || '';
  ...
  if (archiveDir && archiveDir[archiveDir.length - 1] !== '/') {
    archiveDir += '/';
  }
  ...
  languages.forEach(function (lang) {
    let base = (languages.length > 1 ? lang.toString() + '/' : '') + archiveDir;
...
exports.archive_generator = archive_generator;
